...
in {
  ...
  config = rec {
    terminal = "alacritty";
    modifier = "Mod4";
    startup = [{command = "obsidian --ozone-platform=wayland --enable-features=UseOzonePlatform";}];
    ...
    colors = { # based on win95 theme from: https://github.com/jefrecantuledesma/.config/blob/main/sway/config_files/windows_95#LL294
        focused = {
          background = "#000080";
          border = "#000080";
          childBorder = "#ffffff";
